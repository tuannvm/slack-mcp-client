...
type LLMProvider interface {
	...
	GenerateAgentCompletion(ctx context.Context, userDisplayName, systemPrompt string, prompt string, messages []RequestMessage, llmTools []tools.Tool, callbackHandler callbacks.Handler, maxAgentsIterations int) (string, error)
